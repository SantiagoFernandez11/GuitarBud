    ...
    <div className="card">
        ...
        {stats.recentActivity.map((song, index) => (
            <Link 
                ...
                className="block"
            >
                <div className="flex items-center justify-between p-4 bg-gray-700 hover:bg-gray-600 rounded-xl border border-gray-600 hover:border-gray-500 transition-all duration-200 cursor-pointer">
                <div>
                    <p className="font-bold text-gray-100 hover:text-blue-400 transition-colors">{song.title}</p>
